 ...
 * (2) app-foreground rescan, and (3) the rescan the cloud-sync host service
 * runs after every sync. The subscription API is identical to desktop/web so
 * app-core consumes it as-is.
 */
